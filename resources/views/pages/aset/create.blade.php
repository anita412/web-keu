                ...
                <form action="{{ route('aset.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nama_aset">Nama</label>
                                        <input type="text" id="nama_aset" class="form-control @error('nama_aset') is-invalid @enderror" 
                                               name="nama_aset" placeholder="Contoh: aset ABCD, Emas Antam" value="{{ old('nama_aset') }}">
                                        @error('nama_aset')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kategori" id="kategori" class="form-control @error('kategori') is-invalid @enderror" required>
                                            @php
                                                $kategoriOptions = ['kendaraan','tanah_&_rumah','elektronik','photography_&_videography', 'lainnya'];
                                            @endphp
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end" style="gap :10px">
                            <a href="{{ url('/aset/index') }}" class="btn btn-outline-secondary">Kembali</a> 
