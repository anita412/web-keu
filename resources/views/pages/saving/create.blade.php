...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Saving Baru</h1>
    </div>
                ...
                <form action="{{ url('/saving') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_saving" class="form-control @error('nama_saving') is-invalid @enderror" 
                                               name="nama_saving" placeholder="Contoh: saving ABCD, Emas Antam" value="{{ old('nama_saving') }}">
                                        @error('nama_saving')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kategori" id="kategori" class="form-control @error('kategori') is-invalid @enderror" required>
                                            @php
                                                $kategoriOptions = ['guru','modal_usaha','cash','lainnya'];
                                            @endphp
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="penyimpanan_saving" class="form-control @error('penyimpanan_saving') is-invalid @enderror" 
                                               name="penyimpanan_saving" placeholder="" value="{{ old('penyimpanan_saving') }}">
                                        @error('penyimpanan_saving')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        @enderror
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end" style="gap :10px">
                            <a href="{{ url('/saving/index') }}" class="btn btn-outline-secondary">Kembali</a> 
