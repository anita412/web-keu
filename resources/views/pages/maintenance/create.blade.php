...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Maintenance Baru</h1>
    </div>
                ...
                <form action="{{ url('/maintenance') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nama_maintenance">Nama</label>
                                        <input type="text" id="nama_maintenance" class="form-control @error('nama_maintenance') is-invalid @enderror" 
                                               name="nama_maintenance" placeholder="Contoh: maintenance ABCD, Emas Antam" value="{{ old('nama_maintenance') }}">
                                        @error('nama_maintenance')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="penyimpanan_maintenance" class="form-control @error('penyimpanan_maintenance') is-invalid @enderror" 
                                               name="penyimpanan_maintenance" placeholder="" value="{{ old('penyimpanan_maintenance') }}">
                                        @error('penyimpanan_maintenance')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        @enderror
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end" style="gap :10px">
                            <a href="{{ url('/maintenance/index') }}" class="btn btn-outline-secondary">Kembali</a> 
